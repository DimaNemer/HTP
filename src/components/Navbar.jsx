    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center group">
          <div className="relative w-48 h-10 md:w-64 md:h-12 transition-transform duration-300 group-hover:scale-105">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                key={link.label}
                href={link.href}
                className={`font-medium transition-all uppercase text-sm tracking-wide ${
                  isContact
